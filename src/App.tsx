...
import { View, Role, User, DEFAULT_AVATAR } from './types';
...
import ReportQueueView from './components/ReportQueueView';
import BuddyProfileView from './components/BuddyProfileView';
